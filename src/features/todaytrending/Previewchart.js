...
function Previewchart() {
    return (
        <section>
            <p className='font-medium py-2 text-slate-500'><b>NFT</b></p>
            <div className='grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-4'>
                {/* right  */}
                <div className='h-full md:col-span-2 lg:col-span-2'>
                    <div className='shadow-md rounded-xl w-full  h-full'><img src="https://media.istockphoto.com/id/1445807136/photo/business-and-stock-exchange-data-on-the-screen.webp?b=1&s=612x612&w=0&k=20&c=4tt2-5cU3XiHrbQfKIsfk4-QRplLnmeBO9vBtRrxkI8=" className='object-cover w-full h-full rounded-xl' /></div>
                </div>
                {/* center  */}
                <div className='my-auto'>
                    <div className='flex flex-col gap-2'>
                        <div className='border rounded-xl max-h-44 h-32 shadow-md p-2.5 bg-[url(https://cdn.pixabay.com/photo/2020/03/16/15/33/analysis-4937349_1280.jpg)] bg-center bg-cover bg-no-repeat '>
                            <div className='flex  justify-between'>
                                <div className='font-medium text-lg'>
                                    <img src='https://assets.coingecko.com/nft_contracts/images/312/small/mfers.png?1649219344' className='object-cover w-10 h-10 rounded-full inline-block me-1' />
                                    <span className='bg-white'>Ethereum (24Hrs)</span>
                                    <p className='p-1 py-3'>$ 45,048.36</p>
                                </div>
                                <span className='py-2 text-upcolor'>3.5%</span>
                            </div>
                        </div>
