    ...
    return (
        <div className='flex justify-between items-center gap-3 flex-wrap-reverse  px-4 py-2 bg-[#2B2B2B]/50 rounded-[12px] md:flex-nowrap md:gap-0'>
            <div className='text-white capitalize'>
                ...
                <p className='font-normal'>welcome back <b className='text-[12px]'>karthik john!</b></p>
            ...
            <div className='flex items-center gap-2 font-medium  text-white'>
                ...
                <div className='bg-white text-black absolute top-full  border text-center left-0 w-full shadow hidden group-hover/signout:block transition-all ease-in-out duration-1000'><button className='py-2'>sign out</button></div>
                </p>
            </div>
        </div>
    )
